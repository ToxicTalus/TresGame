#include "ThumbnailRendering/TresBlueprintThumbnailRenderer.h"
#include "ShowFlags.h"
#include "SceneView.h"
#include "Misc/App.h"
...
UTresBlueprintThumbnailRenderer::UTresBlueprintThumbnailRenderer(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

bool UTresBlueprintThumbnailRenderer::CanVisualizeAsset(UObject* Object)
{
...
void UTresBlueprintThumbnailRenderer::Draw(UObject* Object, int32 X, int32 Y, uint32 Width, uint32 Height, FRenderTarget* RenderTarget, FCanvas* Canvas)
{
	UBlueprint* Blueprint = Cast<UBlueprint>(Object);
...
void UTresBlueprintThumbnailRenderer::BeginDestroy()
{
...
void UTresBlueprintThumbnailRenderer::BlueprintChanged(class UBlueprint* Blueprint)
{
